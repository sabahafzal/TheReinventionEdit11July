// screens/FinancialGlowUpThemesScreen.js
...
const ROADMAP_KEY = 'financial_glow_up';

export default function FinancialGlowUpThemesScreen() {
  ...
  const handleSelect = (themeKey) => {
    ...
    navigation.navigate('FinancialGlowUpPlan', {
      roadmap,
      theme: themeKey,
      duration,
    });
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Follow these steps in order to get your money moving with calm confidence:
      </Text>
